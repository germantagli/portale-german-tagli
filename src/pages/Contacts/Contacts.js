...
/**
 * @function Contacts Contacts components
 * @returns {JSX.Element}
*/
const Contacts = () => {
            ...
            <Container>
                <Row>
                    <Col xs="12" sm="12" md="12" lg="6">
                        <h1 className="title">{tranlastion("contacts.contacMe")}</h1>
                        <p className="description">{tranlastion("contacts.pleaseContact")}</p>
                        <a cla href="tel:Or call me at +39 3457613300">
                            <p className="description">{tranlastion("contacts.OrCallMeAt")} +39 3457613300</p>
                        </a>
                        <a href="mailto:contact@henrymcdcv.com" >
                            <p className="description">
                                germantagli@gmail.com
                            </p>
                        </a>

                        <div className="socialCard">
                            <p className="m-0 p-0 findMe">{tranlastion("contacts.FindMeOn")}</p>

                            <div className="wrapSocial">
                                <div className="link-wrapper">
                                    <a aria-label="Social link" class="link" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/germantagli">
                                        <div  data-name="icon-facebook">
                                ...
                                <div className="link-wrapper">
                                    <a aria-label="Social link" class=" link" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/german-tagliaferri-241b1838/">
                                        <div  data-name="icon-linkedin">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                    ...
                    <Col xs="12" sm="12" md="12" lg="6" className="mt-5" >
                        <Form>
                            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                <Form.Control type="text" placeholder={tranlastion("contacts.name")} />
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
                                <Form.Control type="email" placeholder={tranlastion("contacts.email")} />
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                <Form.Control as="textarea" rows={3} placeholder={tranlastion("contacts.message")} />
                            </Form.Group>
                        </Form>
                        <div className="text-end">
                            <Button variant="primary" className="text-end">{tranlastion("contacts.send")}</Button>
                        </div>
                    </Col>
                </Row>
            </Container>
